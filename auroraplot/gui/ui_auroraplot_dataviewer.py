...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.starttimeWidget = QtGui.QTimeEdit(self.page_0)
        ...
        self.widget_2 = QtGui.QWidget(self.page_0)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.label_4 = QtGui.QLabel(self.page_1)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 6, 0, 1, 1)
        self.label_5 = QtGui.QLabel(self.page_1)
        self.label_5.setObjectName("label_5")
        self.gridLayout.addWidget(self.label_5, 7, 0, 1, 1)
        self.line = QtGui.QFrame(self.page_1)
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName("line")
        self.gridLayout.addWidget(self.line, 5, 0, 1, 3)
        self.label_8 = QtGui.QLabel(self.page_1)
        self.label_8.setObjectName("label_8")
        self.gridLayout.addWidget(self.label_8, 0, 0, 1, 1)
        self.addPlotButton = QtGui.QPushButton(self.page_1)
        ...
        self.archiveBox = QtGui.QComboBox(self.page_1)
        self.archiveBox.setObjectName("archiveBox")
        self.gridLayout.addWidget(self.archiveBox, 8, 1, 1, 2)
        self.label_9 = QtGui.QLabel(self.page_1)
        self.label_9.setObjectName("label_9")
        self.gridLayout.addWidget(self.label_9, 8, 0, 1, 1)
        self.addDatasetButton = QtGui.QPushButton(self.page_1)
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 112, 112))
        ...
        self.page_3.setGeometry(QtCore.QRect(0, 0, 188, 128))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_0), QtGui.QApplication.translate("MainWindow", "Date and time", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_1), QtGui.QApplication.translate("MainWindow", "Data sets", None, QtGui.QApplication.UnicodeUTF8))
