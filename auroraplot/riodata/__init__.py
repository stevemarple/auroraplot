...
class RioData(Data):
    ...
    @classmethod
    def calculate_qdc_create_times(cls, t: np.datetime64, project: str, site: str) -> Tuple[np.datetime64, np.datetime64, np.datetime64]:
...
class RioRawPower(RioData):
    ...
    def linearize(self):
        r = RioPower(project=self.project,
                     site=self.site,
        ...
        if interp_data is not None:
            for cn in range(len(self.channels)):
                ...
                r.data[cn] = scipy.interpolate.interp1d(interp_data[beam_index + 1], interp_data[0],
                                                        bounds_error=False)(self.data[cn])
...
class RioPower(RioData):
    ...
    @staticmethod
    def load_from_raw_power(file_name: str,
                            archive_data: dict,
                            project: str,
                            site: str, data_type: Data,
        ...
        raw_power = generic_load_converter(file_name, archive_data,
                                           project, site, 'RioRawPower', start_time,
    ...
    def make_qdc(self,
        ...
        sidt_offset, sidt_day = dt64.get_sidereal_time_offset(sample_times, rio_power.get_site_info('longitude'), rio_power.get_start_time())
        ...
        qdc = RioQDC(project=rio_power.get_project(),
