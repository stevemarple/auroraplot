...
class TestRioData(unittest.TestCase):
    ...
    def test_calculate_qdc_create_times(self):
        expected_results = [
            ...
            [np.datetime64('1994-09-02'), np.datetime64('1994-09-02'), np.datetime64('1994-08-31'), np.datetime64('1994-09-18')],
            [np.datetime64('1994-09-03'), np.datetime64('1994-09-02'), np.datetime64('1994-08-31'), np.datetime64('1994-09-18')],
            [np.datetime64('1994-09-16'), np.datetime64('1994-09-16'), np.datetime64('1994-09-14'), np.datetime64('1994-10-02')],
            [np.datetime64('1994-09-17'), np.datetime64('1994-09-16'), np.datetime64('1994-09-14'), np.datetime64('1994-10-02')],
